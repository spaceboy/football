class Events {
    ...
    */
    ...
    // Přepočítá skóre a označí kola penaltového rozstřelu.
    static penaltiesCountScore () {
        var scoreHome = 0;
        var scoreAway = 0;
        var row = 1;
    ...
    // Editace řádku penaltového rozstřelu.
    static penaltiesEditRow (e) {
    ...
    // Zpropagování formuláře do řádku penaltového rozstřelu.
    static penaltiesSetRow (rowNum, data) {
        ...
        if (!row) {
            ...
            Evnt.on(row, "click", Events.penaltiesEditRow);
        }
        ...
        Events.penaltiesCountScore();
    }

    // Reset editoru penaltového rozstřelu.
    static penaltiesEditorReset () {
        let form = Elem.from('form[name="penalties-editor"]');
    ...
    // Vyřídí událost kliknutí na tlačítko v editoru penaltového rozstřelu.
    static clickPenaltiesEditorButton (e) {
        e.preventDefault();
